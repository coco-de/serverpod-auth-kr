...
--
-- Class KakaoAccount as table serverpod_auth_idp_kakao_account
--
CREATE TABLE "serverpod_auth_idp_kakao_account" (
...
-- Indexes
CREATE UNIQUE INDEX "serverpod_auth_kakao_account_user_identifier" ON "serverpod_auth_idp_kakao_account" USING btree ("userIdentifier");
...
--
-- Foreign relations for "serverpod_auth_idp_kakao_account" table
--
ALTER TABLE ONLY "serverpod_auth_idp_kakao_account"
    ADD CONSTRAINT "serverpod_auth_idp_kakao_account_fk_0"
...
--
-- MIGRATION VERSION FOR serverpod_auth_idp_kakao
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp_kakao', '20260604082416036', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260604082416036', "timestamp" = now();
