...
--
-- Class NaverAccount as table serverpod_auth_idp_naver_account
--
CREATE TABLE "serverpod_auth_idp_naver_account" (
...
-- Indexes
CREATE UNIQUE INDEX "serverpod_auth_naver_account_user_identifier" ON "serverpod_auth_idp_naver_account" USING btree ("userIdentifier");
...
--
-- Foreign relations for "serverpod_auth_idp_naver_account" table
--
ALTER TABLE ONLY "serverpod_auth_idp_naver_account"
    ADD CONSTRAINT "serverpod_auth_idp_naver_account_fk_0"
...
--
-- MIGRATION VERSION FOR serverpod_auth_idp_naver
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_auth_idp_naver', '20260604082014186', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260604082014186', "timestamp" = now();
